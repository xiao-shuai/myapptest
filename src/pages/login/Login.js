...
login=()=>{
    ...
    if(this.state.zh==undefined||this.state.zh==''){
      return  this.refs.toast.show('Please enter the account number.')
    }else if(this.state.mm==undefined||this.state.mm==''){
       return this.refs.toast.show('Please enter the account number.33')
    }else{
...
componentWillMount(){
        ...
        return(
            <SafeAreaView style={{flex:1}}>
                ...
                <ScrollView>
                 ...
                 <TextInput style={[ys.t_input]} onChangeText={(mm)=>{
                 this.setState({mm})
 ...
 this.login()
                 ...
                 <View style={{justifyContent:'space-between',flexDirection:'row',marginTop:10}}>
                     ...
                     <Text style={{color:'white',}}>Registered</Text>
                     </TouchableOpacity>
                     <TouchableOpacity onPress={()=>{
